    ...
    return (
        <div className='border-b-2 shadow-md border-gray-100 pb-5'>
            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 '>
                <div className='flex flex-col-reverse md:flex-row min-w-full space-y-8
            ...
            <nav id='bar' className='hidden md:flex justify-center '>
                <div
                    className='flex flex-col md:flex-row justify-center md:space-y-0 my-4 space-y-4  text-center text-gray-500'>
