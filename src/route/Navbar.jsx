...
const Navbar = () => (
    <div className="border-b-2 shadow-md border-gray-100 pb-5">
        ...
        <div className="max-w-7xl mx-auto my-5 px-4 sm:px-6 ">
            <div className="min-w-full flex  py-6 md:justify-between  md:space-x-10">
                <input className="leading-none focus:outline-none border-b-2 hover:border-b-3 border-red-800 w-1/4" type="text" placeholder=' Searsh..' />
                ...
                <div className="-mr-2 -my-2 md:hidden">
                    <button type="button" className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-900 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" aria-expanded="false">
                ...
                <div className="flex justify-end ">
                    <div className="whitespace-nowrap pt-1  mx-3 flex justify-center space-x-1 ">
        ...
        <nav className="flex justify-center my-3">
            <div>
                <NavLink to="MarketPlace_AisModa/cart" href="#" className="mx-8 text-base  text-gray-500 hover:text-red-900"> Cart </NavLink>
                <a href="#" className="mx-8 text-base  text-gray-500 hover:text-red-900"> Docs </a>
                <a href="#" className="mx-8 text-base  text-gray-500 hover:text-red-900"> Docs </a>
                <a href="#" className="mx-8 text-base  text-gray-500 hover:text-red-900"> Docs </a>
                <a href="#" className="mx-8 text-base  text-gray-500 hover:text-red-900"> Docs </a>
                <a href="#" className="mx-8 text-base  text-gray-500 hover:text-red-900"> Docs </a>
