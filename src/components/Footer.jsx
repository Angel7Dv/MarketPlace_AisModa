    ...
    return (
        <footer className='border-t-2 py-16 flex flex-col'>
                    ...
                    <ul>
                        <li className='mb-4'>
                            <a href='https://flowbite.com' target='_blank' rel="noreferrer"
                                className='text-gray-600 hover:underline'>Flowbite</a>
                        </li>
                        <li>
                            <a href='https://tailwindcss.com/' target='_blank' rel="noreferrer" 
                                className='text-gray-600 hover:underline'>Tailwind CSS</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul>
                        <li className='mb-4'>
                            <a href='https://github.com/themesberg/flowbite' target='_blank' rel="noreferrer"
                                className='text-gray-600 hover:underline'>Github</a>
                        </li>
                        <li>
                            <a href='https://discord.gg/4eeurUVvTy' target='_blank' rel="noreferrer"
                                className='text-gray-600 hover:underline'>Discord</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul>
                        <li className='mb-4'>
                            <a href='/' target='_blank' rel="noreferrer" className='text-gray-600 hover:underline'>Privacy
                                Policy</a>
                        </li>
                        <li>
                            <a href='/' target='_blank' rel="noreferrer" className='text-gray-600 hover:underline'>Terms
                                &amp; Conditions</a>
                        </li>
                    </ul>
                </div>
            ...
            <div className=' flex flex-col items-center justify-around'>
                ...
                <span className='text-sm text-gray-500 text-center'><a href='https://github.com/RagAndRoll' target='_blank' rel="noreferrer" className='hover:underline'>© 2022  RagAndRoll. All Rights Reserved.</a>
                </span>
            </div>
        </footer>
    )
