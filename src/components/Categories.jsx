...
import Category,{CategoryImg}  from "./categories/Category";
const Categories = () => {
  return (
    // <div className="">
    ...
    //   </div>
    // </div>
    <section className="w-screen h-[32rem] relative my-5">
        <button className="absolute left-0 p-2 top-1/2 -translate-y-1/2 text-4xl h-full hover:bg-sky-500 opacity-40 z-[2]"><i class="fa-solid fa-circle-chevron-left"></i></button>
        <div className="absolute flex gap-36 px-36">
        <Category>
        <CategoryImg src={'https://i.ibb.co/fDngH9G/carosel-1.png'} alt="black chair and white table"/>
        </Category>    
        <Category>
        <CategoryImg src={'https://i.ibb.co/fDngH9G/carosel-1.png'} alt="black chair and white table"/>
        </Category>
        </div>   
        <button className="absolute right-0 p-2 top-1/2 -translate-y-1/2 text-4xl h-full hover:bg-sky-500 opacity-40 z-[2]"><i class="fa-solid fa-circle-chevron-right"></i></button>
    </section>
  );
};
