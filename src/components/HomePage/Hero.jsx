    ...
    "
        >
            ...
            <div className="flex justify-center items-center flex-col bg-gray-800 bg-opacity-30  absolute w-full h-full ">
                ...
                <h1 className="text-white text-4xl  md:text-6xl font-semibold">MarketPlace</h1>

                <div className="flex justify-center items-center">

                    <button className="group-hover:bg-opacity-90 
                    hover:bg-gray-100  hover:text-red-600 text-md font-semibold 
                    text-gray-50 px-2 sm:px-12 mt-8 p-3 border-2 border-white">
