    ...
    return (
        <div className='mx-24'>
            <div className='flex items-center justify-center w-full h-full '>
                ...
                <div ref={slider} class='snap-x overflow-x-hidden scroll-smooth h-full flex items-center justify-start'>
                    {images.map((e, i) => (
                        <div key={i} className='snap-start flex flex-col flex-shrink-0 w-1/4 mx-4'>
